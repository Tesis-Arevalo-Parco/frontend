...
const treeData = [
	...
	},
	{
		...
		children: [
			...
			{ title: '[backup] instalaciones de respaldo', key: 'facilities_backup' },
		],
	},
	{
		title: '[P] Personal',
								...
								children: [
									...
									},
									{
										...
										children: [
											{
												title: '3G',
												key: 'iot_lnet_communication_types_ma_network_cell_3g',
											},
											{
												title: '4G',
												key: 'iot_lnet_communication_types_ma_network_cell_4g',
											},
											{
												title: '5G',
												key: 'iot_lnet_communication_types_ma_network_cell_5g',
											},
										],
									},
									{
...
const CheckBoxTree = () => {
	...
	return (
		<Tree checkable onSelect={onSelect} onCheck={onCheck} treeData={treeData} />
	)
}
